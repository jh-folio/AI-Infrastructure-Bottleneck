...
def synthetic_package(folder):
    ...
    files = {
        ...
        '.claude-plugin/plugin.json': json.dumps({'name': 'ai-infrastructure-bottleneck', 'version': flow.package_version()}),
        '.claude-plugin/marketplace.json': json.dumps({'name': 'ai-infrastructure-bottleneck-marketplace',
                                                       'owner': {'name': 'jh-folio'},
                                                       'plugins': [{'name': 'ai-infrastructure-bottleneck', 'source': './'}]}),
        '.agents/plugins/marketplace.json': json.dumps({'name': 'ai-infrastructure-bottleneck-marketplace',
                                                        'plugins': [{'name': 'ai-infrastructure-bottleneck',
